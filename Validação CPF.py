...
while True:
    ...
    #Faz a tratativa da string de input
    cpf_filtrado = re.sub(r'[^0-9]', '', cpf_original)
    ...
    if busca_repeticao == cpf_filtrado: cpf_filtrado = '123456789'
    ...
    if digito1_esperado == int(cpf_filtrado[-2]) and digito2_esperado == int(cpf_filtrado[-1]): print("Este CPF é válido")           
